...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $sql = "UPDATE classes SET name='$name', description='$description', url='$url' WHERE id=$id";
  ...
  if (!empty($_FILES["image"]["name"])) {
    ...
    $sql = "UPDATE classes SET image='$image' WHERE id=$id";
    mysqli_query($conn, $sql);
  }
...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Edit Class - Music Society</title>
  </head>
  <body>
