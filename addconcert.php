...
if (isset($_POST['submit'])) {
    ...
    // Insert the new class into the concerts table
    $sql = "INSERT INTO concerts (name, description, image, url) VALUES ('$name', '$description', '$image_path', '$url')";
...
<html>
  <head>
    <title>Music Society Admin Panel - Add Concerts</title>
  </head>
  <body>
    <h1>Add Concerts</h1>
